...
void main()
{
	...
	while(j!=40)
	   {
		...
		for (i=0;i<2;i++)
			{   initgraph(&gd,&gm,"C://TURBOC3//BGI");
                ...
                circle(120,250,70);
				setfillstyle(1,14);
				floodfill(120,250,WHITE);

				//DETAILS
				setcolor(BLACK);
				circle(90+8*i,215,10); //LEFT EYE
				circle(150+8*i,215,10); //RIGHT EYE
				line(80,270,160,270); //SMILE
				circle(90+8*i,220,3); //LEFT EYE PUPIL
				circle(150+8*i,220,3); //RIGHT EYE PUPIL

				//FILLING EYE PUPIL
				setfillstyle(1,0);
				floodfill(90+8*i,220,BLACK);
				floodfill(150+8*i,220,BLACK);
	...
	for (i=0;i<2;i++)
	{
		...
		setfillstyle(1,0);
				...
				//DETAILS
				setcolor(BLACK);
				circle(95-8*i,215,10); //LEFT EYE
				circle(155-8*i,215,10);//RIGHT EYE
				arc(120,220,200+20*i,340-20*i,60);
				//line(80,270,160,270);//SMILE
				circle(95-8*i,220,3);//LEFT EYE PUPIL
				circle(155-8*i,220,3);//RIGHT EYE PUPIL

				//FILLING EYE PUPIL
				setfillstyle(1,0);
				floodfill(95-8*i,220,BLACK);
				floodfill(155-8*i,220,BLACK);
